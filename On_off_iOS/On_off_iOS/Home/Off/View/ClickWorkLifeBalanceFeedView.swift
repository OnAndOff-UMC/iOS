//
//  ClickWorkLifeBalanceFeedView.swift
//  On_off_iOS
//
...
final class ClickWorkLifeBalanceFeedView: DimmedViewController {
    ...
    var feedSubject: PublishSubject<Feed> = PublishSubject()
    var successConnect: PublishSubject<Void> = PublishSubject()
    var insertFeedSubject: PublishSubject<Feed> = PublishSubject()
